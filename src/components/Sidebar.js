...
const Sidebar = () => {
  ...
  return (
    <div 
      className={`${isOpen ? 'right-0' : '-right-full'} w-full bg-white fixed top-0 h-full shadow-2xl 
    ...
    >
      ...
      <div className='flex flex-col gap-y-3 py-4 mt-4'>
        <div className='flex w-full justify-between items-center'>
          ...
          <div 
            onClick={clearCart} 
            className='cursor-pointer py-4 w-12 h-12 flex justify-center items-center text-xl bg-red-600 text-gray-200'
          >
            <FiTrash2 />
          </div>
        </div>
